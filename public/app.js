...
(0, _jquery2.default)('#btn-search-close-max').click(searchInputClose);
(0, _jquery2.default)('#btn-search-close-min').click(searchInputClose);
(0, _jquery2.default)(document).on('keyup', function (evt) {
    if (evt.keyCode == 27) {
        searchInputClose();
    }
});

(0, _jquery2.default)('.error_close').click(function () {
    (0, _jquery2.default)('.php_error').toggleClass('disable');
});

// Progress bar
(0, _jquery2.default)(window).scroll(function () {
    var ratio = (0, _jquery2.default)(document).scrollTop() / (((0, _jquery2.default)(document).height() - (0, _jquery2.default)(window).height()) / 100);
...
(0, _jquery2.default)('#btn-menu-close').click(function () {
    (0, _jquery2.default)('.m-nav').toggleClass('disable');
    (0, _jquery2.default)('#btn-search-min').toggleClass('disable');
    (0, _jquery2.default)('#btn-menubar').toggleClass('disable');
    (0, _jquery2.default)('#btn-menu-close').toggleClass('disable');
